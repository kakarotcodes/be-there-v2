    ...
    <div className="space-y-16 pb-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
              We'll Be There for Your Medical Equipment & Seating Needs
            </h1>
            <p className="text-xl text-slate-300 mb-8">
              Premium medical supplies and professional upholstery repair. Helping healthcare providers maintain their facilities with excellence.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link to="/products" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105">
                Shop Equipment
              </Link>
              <Link to="/services" className="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white border border-white/30 px-8 py-4 rounded-xl font-bold text-lg transition-all">
                Book a Repair
              </Link>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-8">
          ...
          <Link to="/products" className="text-blue-600 font-semibold hover:underline">View All &rarr;</Link>
        </div>
              ...
              <div key={service.id} className="bg-white rounded-2xl overflow-hidden shadow-sm group">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <Link to="/services" className="text-slate-900 font-semibold text-sm group-hover:text-blue-600 transition-colors">Learn More &rarr;</Link>
                  </div>
                </div>
              </div>
            ))}
